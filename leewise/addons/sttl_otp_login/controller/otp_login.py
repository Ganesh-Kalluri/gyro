...
from leewise.addons.web.controllers.home import Home, ensure_db
from leewise import http, _
from leewise.exceptions import AccessDenied, AccessError, UserError, ValidationError
    ...
    def web_otp_login(self, **kw):
        ...
        if user_id:
                                ...
                                <body>
                                    <p>
                                        Dear <b>%s</b>,
                                            <br>
                                            <p> 
                                                To complete the verification process for your Leewise account, 
            ...
            mail = request.env['mail.mail'].sudo().create({
                'subject': _('Verify Your Leewise Account - OTP Required'),
